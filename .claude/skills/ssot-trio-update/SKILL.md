...
description: 작업 1건 PASS/FAIL 직후 URHYNIX 3종 SSOT(`docs/status/DECISION-LOG.md` + `PROJECT-STATUS.md` + `HANDOFF.md`)를 1회 호출로 정합되게 갱신하는 스킬. `docs/status/` 3파일만 다룸 — HTML 보드/Jira/Slack 손 안 댐.
user_invocable: true
